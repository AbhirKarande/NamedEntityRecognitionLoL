...
def main(model=None, new_model_name='new_model', output_dir=None, n_iter=10):
    ...
    test_text = 'LOUIS VUITTON M40096 Handbag Priscilla Multi-color canvas Multi-color canvas'
    doc = nlp(test_text)
